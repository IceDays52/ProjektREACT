        ...
        <>
            ...
            <section className="hero-main-container" ref={contactRef}  >
                ...
                <div className="PAPA contact-card">
                    ...
                    <form className="my-form">
                        <input type="text" placeholder="Twoje imię" className="dark-input" />
                        <input type="email" placeholder="Twój e-mail" className="dark-input" />
                        <textarea placeholder="W czym możemy pomóc?" className="dark-input dark-textarea"></textarea>
                        <button type="button" className="start-btn small-btn">Wyślij wiadomość</button>
                    </form>
                </div>
            </section>
        </>
